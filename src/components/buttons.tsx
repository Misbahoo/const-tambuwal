...
const Buttons = (props:any) => {
    ...
    return (
        <div className="flex flex-row">
            ...
            {disableNext ? <div className="flex flex-1 justify-end"><button type="button" className="btn bg-gray-300 text-gray-400 m-10" disabled>Next</button></div> : <div className="flex flex-1 justify-end"><button type="button" className="btn bg-blue-600 text-white m-10 hover:bg-green-400" onKeyDown={handleKeyPress} onClick={nextButton}>Next</button></div> }
